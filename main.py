...
1. 저희 디스코드 서버는 욕설/비속어/반말은 상대방이 불쾌하지만 않다면 (상대방이 불쾌하다 했는데 계속 할 시 제재 대상) 허용입니다. 단, 성적인 대화, 정치 드립, 민감한 주제에 대한 대화, 음지적인 대화(성적인 거 등. 서버 음지화 요구 포함) 등은 금지됩니다. 또한 위키 관련 대화도 금지입니다.
