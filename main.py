...
automod_keyword5 = ["따먹", "쇼타", "로리", "촉수", "퍼리", "창녀", "오고곳", "통구이", "전라디언", "쟈지", "보지구멍", "씹구녕", "찌찌", "으럇으럇", "자지푸딩", "쟈지푸딩", "섹스", "부랄", "헤으응", "해으응", "헤응", "헤으읏", "하응", "하으응", "색스", "SEX", "sex", "Sex", "SEx", "sEX", "seX", "sEx", "불알", "강간", "응기잇", "오고곡", "응긱", "응깃", "야스", "YAS", "응긋", "가버렷", "빠구리"] # 부적절한 단어 (성적인 거)
...
raid_keyword1 = ["이세한", "불우한 가정환경이 만들어낸 괴물", "홍어성민서버", "홍성민서버", "서버개털리죠", "본명:홍성민", "실명:홍성민", "나이:14", "거주지:서울", "재학중인학교:", "본인왈전학감"] # 아이온 테러 방지
